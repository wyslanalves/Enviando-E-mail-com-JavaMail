...
public class ObjetoEnviaEmail {
	...
	public void enviarEmail(boolean envioHTML) throws Exception {
		...
		properties.put("mail.smtp.socketFactory.class", "javax.net.ssl.SSLSocketFactory");// Class socket de conexão ao
																							// SMPT
	...
	public void enviarEmailAnexo(boolean envioHTML) throws Exception {
		...
		for (FileInputStream fileInputStream : arquivos) {
			...
			/*
			 * Onde é passado o simuladorDePDF você passa o seu arquivo grava no banco de
			 * dados
			 */
	 ...
	 * Stream de Arquivo. Pode estar e um banco de dados, ou em uma pasta.
	 * 
